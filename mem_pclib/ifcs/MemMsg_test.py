...
def test_req_fields():
  ...
  msg = ReqType( MemMsgType.READ, 7, 0x1000, 3, 0, 0 )
  ...
  msg = ReqType( MemMsgType.WRITE, 9, 0x2000, 0, 0, 0xdeadbeef )
...
def test_req_str():
  ...
  # Verify string
  assert str(msg) == "rd:07:1000:3:0:          "

  ReqType = mk_mem_req_msg(4,16,40)

  # Create msg
  msg = ReqType( MemMsgType.WRITE, 9, 0x2000, 4, 0, 0xdeadbeef )

  # Verify string
  assert str(msg) == "wr:9:2000:4:0:00deadbeef"
