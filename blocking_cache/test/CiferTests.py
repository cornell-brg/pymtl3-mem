...
class CiferTests:
  ...
  def test_cifer_amo_single_req( s, dump_vcd, test_verilog, stall_prob=0, latency=1, \
    src_delay=0, sink_delay=0 ):
    msgs = [
        #    type  opq   addr   len  data     type  opq test len  data
  ...
  def test_cifer_amo_check_clean( s, dump_vcd, test_verilog, stall_prob=0, latency=1, \
    src_delay=0, sink_delay=0 ):
    msgs = [
        #    type  opq   addr       len data         type  opq test len  data
