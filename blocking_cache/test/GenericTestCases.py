...
class GenericTestCases:
  ...
  @pytest.mark.parametrize(
    ...
    ("16B-2", rd_hit_1s,          0.0,       1,      0,        0   ),
    ("16B-2", wr_hit_1s,          0.0,       1,      0,        0   ),
    ("16B-2", wr_miss_1s,         0.0,       1,      0,        0   ),
    ("16B-2", rd_hit_2s,          0.0,       1,      0,        0   ),
    ("16B-2", wr_hit_2s,          0.0,       1,      0,        0   ),
    ("16B-2", wr_miss_2s,         0.0,       1,      0,        0   ),
    ("16B-2", ev_2way,            0.0,       1,      0,        0   ),
    ...
    ("16B-2", rd_hit_1s,          0.0,       2,      1,        2   ),
    ("16B-2", wr_hit_1s,          0.0,       2,      1,        2   ),
    ("16B-2", wr_miss_1s,         0.0,       2,      1,        2   ),
    ("16B-2", rd_hit_2s,          0.0,       2,      1,        2   ),
    ("16B-2", wr_hit_2s,          0.0,       2,      1,        2   ),
    ("16B-2", wr_miss_2s,         0.0,       2,      1,        2   ),
    ("16B-2", ev_2way,            0.0,       2,      1,        2   ),
