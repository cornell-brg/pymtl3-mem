  ...
  def construct( s,
    ...
    def comb_block_M0(): # logic block for setting output ports
      ...
      if s.val_M0: #                                            tag_wben      |wd_mux|mr_mux|tg_ty|tg_v|dty|val
        if s.is_refill_M0:                    s.cs0 = concat( BitsTagWben(0xf), b2(1),  b1(1),  wr ,  y , n , y )    
        elif s.is_write_refill_M0:            s.cs0 = concat( BitsTagWben(0xf), b2(2),  b1(1),  wr ,  y , y , y ) 
        else:
          if (s.cachereq_type_M0 == INIT):    s.cs0 = concat( BitsTagWben(0xf), b2(0),  b1(0),  wr,   y , n , y )
          elif (s.cachereq_type_M0 == READ):  s.cs0 = concat( BitsTagWben(0x0), b2(0),  b1(0),  rd,   y , n , n )
          elif (s.cachereq_type_M0 == WRITE): s.cs0 = concat( BitsTagWben(0x0), b2(0),  b1(0),  rd,   y , n , n )
          else:                               s.cs0 = concat( BitsTagWben(0x0), b2(0),  b1(0),  rd,   n , n , n ) 
      else:                                   s.cs0 = concat( BitsTagWben(0x0), b2(0),  b1(0),  rd,   n , n , n )
      ...
      if s.val_M2:                                     #  word_mux|rdata_mux|memreq|cacheresp  
        if s.is_refill_M2:                   
          ...
          if s.cachereq_type_M2 == INIT:     s.cs2 = concat(mxsel0,   b1(0) ,    n ,     y   )
            ...
            if s.is_write_refill_M2:         s.cs2 = concat(mxsel0,   b1(0) ,    n ,     n   )
            elif s.hit_M2[0]:                s.cs2 = concat(mxsel0,   b1(0) ,    n ,     y   )
