#=========================================================================
# 128 bits x 512 words SRAM model
#=========================================================================

from pymtl           import *
from SramGenericPRTL import SramGenericPRTL

class SRAM_128x512_1P( Component ):
  ...
  vblackbox      = True
  vbb_modulename = "SRAM_128x512_1P"
  vbb_no_reset   = True
  vbb_no_clk     = True
  ...
  def construct( s ):
    ...
    s.A1   = InPort ( Bits9   )  # address
    s.I1   = InPort ( Bits128 )  # write data
    s.O1   = OutPort( Bits128 )  # read data
    s.WBM1 = InPort ( Bits16  )  # byte write en

    # instantiate a generic sram inside

    s.sram_generic = SramGenericPRTL( 128, 512 )
